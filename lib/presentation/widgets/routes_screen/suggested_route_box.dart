...
class SuggestedRouteBox extends StatefulWidget {
  ...
  /// Constructs a [SuggestedRouteBox] widget.
  ///
  ...
  @override
  State<StatefulWidget> createState() => _SuggestedRouteBoxState();
}

class _SuggestedRouteBoxState extends State<SuggestedRouteBox> {
  @override
                  ...
                  child: Row(
                    ...
                    children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                padding: const EdgeInsets.fromLTRB(5, 2, 5, 2),
                                child: const Text("144", style: TextStyle(
                                    fontSize: 12,
                                    color: Colors.white
                                ))
                              )
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text("14:58 • Finish", style: TextStyle(
                            color: const Color(0xFF000000).withOpacity(0.5),
                            fontSize: 13
                          )),
                          const Row(
