...
class BusPositionsRepository  {
  ...
  // Future<List<BusMarker>> initBusMarkers() {
  //   Timer.periodic(const Duration(seconds: 10), (_) {
  //     _updateBusLocations();
  //   });
  // }

  // Should return modal stricte created for ...
  // more here: https://www.youtube.com/watch?v=kLDfhamoqe0&ab_channel=Flutterly
  // Future<List<BusMarker>> getBusMarkers() async {
  //
  // }
